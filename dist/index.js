...
try {
    const version = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('version', { required: true });

    if (!(0,semver__WEBPACK_IMPORTED_MODULE_1__.valid)(version)) {
        throw new Error(`${version} is not a valid semver string.`);
    }

    const parts = {
        major: (0,semver__WEBPACK_IMPORTED_MODULE_1__.major)(version).toString(),
        minor: (0,semver__WEBPACK_IMPORTED_MODULE_1__.minor)(version),
        patch: (0,semver__WEBPACK_IMPORTED_MODULE_1__.patch)(version),
